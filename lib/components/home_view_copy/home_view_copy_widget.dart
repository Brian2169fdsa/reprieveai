...
import 'home_view_copy_model.dart';
export 'home_view_copy_model.dart';

class HomeViewCopyWidget extends StatefulWidget {
  const HomeViewCopyWidget({super.key});

  @override
  State<HomeViewCopyWidget> createState() => _HomeViewCopyWidgetState();
}

class _HomeViewCopyWidgetState extends State<HomeViewCopyWidget> {
  late HomeViewCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeViewCopyModel());
