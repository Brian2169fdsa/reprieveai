...
import 'home_view_test_d_e_l_e_t_e_model.dart';
export 'home_view_test_d_e_l_e_t_e_model.dart';

class HomeViewTestDELETEWidget extends StatefulWidget {
  const HomeViewTestDELETEWidget({super.key});

  @override
  State<HomeViewTestDELETEWidget> createState() =>
      _HomeViewTestDELETEWidgetState();
}

class _HomeViewTestDELETEWidgetState extends State<HomeViewTestDELETEWidget>
    with TickerProviderStateMixin {
  late HomeViewTestDELETEModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeViewTestDELETEModel());
