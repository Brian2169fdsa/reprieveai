...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF3B82E6);
  late Color secondary = const Color(0xFF60A5FA);
  ...
  late Color secondaryText = const Color(0xFF8B95A7);
  late Color primaryBackground = const Color(0xFFF5F6F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x1A3B82E6);
  late Color accent2 = const Color(0x1A60A5FA);
  late Color accent3 = const Color(0x1A93C5FD);
  late Color accent4 = const Color(0xFFEFF4FB);
